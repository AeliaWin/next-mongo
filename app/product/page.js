...
export default function Home() {
  ...
  async function fetchProducts() {
    const data = await fetch("https://next-mongo-olive.vercel.app/api/product");
  ...
  const createProduct = (data) => {
    fetch("https://next-mongo-olive.vercel.app/api/product", {
      method: "POST",
      headers: {
  ...
  const deleteById = (id) => async () => {
    ...
    await fetch(`https://next-mongo-olive.vercel.app/api/product/${id}`, {
      method: "DELETE",
    });
    fetchProducts();
  }
